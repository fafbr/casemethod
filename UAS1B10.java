...
public class UAS1B10 {
    ...
    public static void tambahData() {
        ...
        // validasi khusus beasiswa riset
        if (data[jml][3].equalsIgnoreCase("Riset") && penghasilan >= 1000000) {
            System.out.println("Beasiswa Riset hanya bisa diambil jika penghasilan orang tua dibawah Rp 1.000.000.");
            return;
        }
